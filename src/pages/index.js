      ...
      <section className="bg-green-200 text-blue-800 py-16">
        <div className="mx-auto w-10/12 flex">
          <article className="mr-5">
            ...
            <div>
              <button className="mt-9 text-sm py-4 px-12 bg-blue-800 text-white font-bold rounded-3xl tracking-wider">GET 3 MONTHS FREE</button>
            </div>
          </article>
          <StaticImage alt="" src="https://i.scdn.co/image/ab671c3d0000f430f0d170dfe2d4f4e2ec3eadde" />
        </div>
      </section>
    </Layout>
  );
